...
const initItem = {
  ...
  orgDt: "", //변경전 일자
  seq: "", //채번
  category: "5", //등록화면. 1,2 고철, 3 물류, 4 구매, 5 환경안전, 이외 기간계에서 처리
  categoryNm: "", //등록화면명
  turn: "", //배차순번
  ioGb: "2", //입출구분 1: 입고, 2: 출고
...
//상차지 검색 URL
const SERARCH_USER_URL = "/urgentdispatch/safety/searchSafetyDispatchList";
//상차지 저장 URL
const SAVE_USER_URL = "/urgentdispatch/safety/saveSafetyDispatchList";
...
const setItemInfo = (itemInfo) => {
  ...
  //   prodCd: prodCd,
  // });
  // setOldValues({ ...oldValues, prodNm: itemInfo.prodNm });
...
const restoreCustInfo = () => {
  // setFieldValues({ ...fieldValues, custNm: oldValues.custNm });
};
